        ...
        <div className="p-4 w-full lg:py-6 lg:px-10">
            ...
            <div className="">
                <ul className="capitalize inline-flex">
                    ...
                    <li className="text-sm lg:text-md mx-2 border-2 border-gray-800 px-4 py-1 rounded-full"><a href="#">furnitures</a></li>
                    <li className="text-sm lg:text-md mx-2 border-2 border-gray-800 px-4 py-1 rounded-full"><a href="#">clothing</a></li>
                </ul>
            </div>
